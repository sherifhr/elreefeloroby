...
def save_house():
    ...
    try:
        ...
        #return 'House record saved successfully'
...
@app.route('/save_house2', methods=['GET', 'POST'])
def save_house2():
    try:
        daily_rent=request.form['daily_rent']
        ad_no =request.form['ad_no']
...
#        return render_template('test-buttons2.html')
#        return render_template('test-flipImage.html')
...
def show_store_adv():
    try:
        ...
        return render_template('page-1.html', store=store, owner=owner)    
